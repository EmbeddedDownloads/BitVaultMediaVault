...
public class BetterVideoPlayer extends RelativeLayout implements IUserMethods,
    ...
    //This is used to change the type of progress bar while buffering
    ...
    private int mLoadingStyle = CIRCLE;
    ...
    protected void onFinishInflate() {
        ...
        mControlsLp.setMargins(0,0,0,100);
        ...
        // Setting the seek bar progess and thumb color
        mSeeker.getProgressDrawable().setColorFilter(Color.parseColor(context.getString(R.string.seekbar_progress_drawable)), PorterDuff.Mode.SRC_IN);
        mSeeker.getThumb().setColorFilter(Color.parseColor(context.getString(R.string.seekbar_thumb)), PorterDuff.Mode.SRC_IN);
