...
/**
 * Created by vvdn on 8/10/2017.
 */

public class AlbumViewDividerDecorator  extends RecyclerView.ItemDecoration {
    ...
    public AlbumViewDividerDecorator(Context context) {
        TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = ContextCompat.getDrawable(context, R.drawable.album_view_divider);
        a.recycle();
