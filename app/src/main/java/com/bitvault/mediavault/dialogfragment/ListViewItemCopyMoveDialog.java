...
public class ListViewItemCopyMoveDialog extends DialogFragment implements DialogAdapter.OnItemClickListener {
            ...
            case R.id.ok:
                if (parentDirectory != null && parentDirectory.length() > 0) {
                    if (FileUtils.getParentName(parentDirectory).equalsIgnoreCase(keyName)) {
                        ...
                        ((LandingActivity) getActivity()).actionCopyOnDialogResponse(parentDirectory, actionType);
                    ...
                    if (directoryName.length() <= 20) {
                        if (FileUtils.getSpecialCharacterValidation(directoryName)) {
                            ...
                            if (parentDirectory.contains(getString(R.string.directory_created))) {
                                ...
                                ((LandingActivity) getActivity()).actionCopyOnDialogResponse(FileUtils.getInternalStorage() + "/" +
