...
public class MultiFileSelectAdapter extends RecyclerView.Adapter<MultiFileSelectAdapter.DetailsViewHolder> {
     ...
     */
    public void setOnItemClickListener(MultiFileSelectAdapter.OnItemClickListener onItemClickListener) {
     ...
     */
    public MultiFileSelectAdapter(Activity context, ArrayList<ImageDataModel> data, MediaFileDuration mediaFileDuration) {
    ...
    @Override
    public MultiFileSelectAdapter.DetailsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.directory_detail_adapter, parent, false);
        return new MultiFileSelectAdapter.DetailsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final MultiFileSelectAdapter.DetailsViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 */
                if (MultiFileSelectAdapter.this.onItemClickListener != null && imageDataModel != null) {
     ...
     */
    @Override
    public void onViewRecycled(MultiFileSelectAdapter.DetailsViewHolder holder) {
    ...
    /**
     * Method to select one photo at a time and update view
     * @param position
     */
    public void toggleSingleSelect(int position) {
        clearSelection();
